...
import static oop_t2_payroll.StatutoryDeductions.calculatePagIbig;
import static oop_t2_payroll.StatutoryDeductions.calculatePhilHealth;
import static oop_t2_payroll.StatutoryDeductions.calculateSSS;
import static oop_t2_payroll.StatutoryDeductions.calculateWHTax;
...
//        setIconImage();
    ...
    public Integer matchWorkedHours() {
        ...
        JOptionPane.showMessageDialog(null, "No record for the selected covered period. Try Another Year or Month pairing.");
